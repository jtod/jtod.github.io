...
//const skipPreTags = /^(<[^>]*>)(.*)(<[^>]*>)$/;
//    let xs = "<pre xyz>a\nb</pre>";
//    xs.replace (openingPreTag, "FOUNDOPEN");
//    console.log (`xs after open  = ${xs}`);
//    xs.replace (closingPreTag, "FOUNDCLOSE");
//    console.log (`xs after close = ${xs}`);
//    let matchResult = xs.match(openingPreTag);
